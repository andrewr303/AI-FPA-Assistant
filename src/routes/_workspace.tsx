  ...
  return (
    <CopilotProvider>
      <div className="flex min-h-screen bg-background text-foreground bg-grid">
        ...
        <nav className="md:hidden fixed bottom-0 inset-x-0 z-40 border-t border-border bg-background/95 backdrop-blur px-2 py-2 grid grid-cols-4 gap-1">
          {mobileNav.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.to}
                className={cn(
                  "rounded-md px-2 py-2 text-[11px] flex flex-col items-center gap-1",
